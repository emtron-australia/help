---
title: "KV Series Wiring Harness Specification"
weight: 8
---
...
{{% badge style="note" %}}NOTE{{% /badge %}} Any unused pins or not-fitted wires **MUST** have blanking bungs fitted to the connector to keep the plug rated at its IP standard.
...
{{< figure src="/img/kv-wiring-harness/connector-a.png" caption="Connector A — TE Superseal 26 Way / Key 2." >}}
...
{{< figure src="/img/kv-wiring-harness/connector-b.png" caption="Connector B — TE Superseal 34 Way / Key 2." >}}
...
{{< figure src="/img/kv-wiring-harness/connector-c.png" caption="Connector C — TE Superseal 34 Way / Key 1." >}}
...
{{< figure src="/img/kv-wiring-harness/connector-c-sensor-0v-branch.jpeg" caption="Connect a 0.50 sq mm AVSS wire, 70mm in length, to Pins C17 and C25. At the end, branch into x4 0.50 sq mm AVSS wires. Colour = Black." >}}
...
{{< figure src="/img/kv-wiring-harness/connector-d.png" caption="Connector D — TE Superseal 26 Way / Key 1." >}}
...
{{< figure src="/img/kv-wiring-harness/d21-5v-eng-branch.jpeg" caption="Pin D21 (5V Eng Supply) is a branched connection feeding the engine sensor 5V supply." >}}
...
{{< figure src="/img/kv-wiring-harness/kv8-pinout.jpeg" caption="KV8 ECU pinout (Rev 2) — Connectors A, B, C and D, looking into the ECU." >}}

## Appendix B – KV12 ECU Pinout Drawing

{{< figure src="/img/kv-wiring-harness/kv12-pinout.jpeg" caption="KV12 ECU pinout (Rev 2) — Connectors A, B, C and D, looking into the ECU." >}}

## Appendix C – KV16 ECU Pinout Drawing

{{< figure src="/img/kv-wiring-harness/kv16-pinout.jpeg" caption="KV16 ECU pinout (Rev 2) — Connectors A, B, C and D, looking into the ECU." >}}

## Appendix D – KV Series ECU Wiring

{{< figure src="/img/kv-wiring-harness/kv-ecu-wiring.jpeg" caption="KV Series (Rev 2) ECU wiring overview (drawing A20)." >}}

## Appendix E – KV Series Ethernet Wiring

{{< figure src="/img/kv-wiring-harness/kv-ethernet-wiring.jpeg" caption="KV Series Ethernet wiring / tuning cable pinout (drawing A24)." >}}
