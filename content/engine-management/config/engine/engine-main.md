...
>[!INFO] Rotary engines are regarded as 2 stroke engines
...
>**NOTE:** This input effects the [Torque Model](<torque-modelling.md>) as well as the [Fuel Model: Expansion Ratio](<fuel-model-expansion-ratio.md>) calculation.