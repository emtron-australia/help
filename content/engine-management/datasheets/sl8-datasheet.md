---
title: "SL8 ECU Datasheet"
weight: 8
---

**Rev 1.0** &nbsp;•&nbsp; Emtron SL8 ECU

{{< figure src="/img/sl8-datasheet/page01_img02.jpeg" caption="Emtron SL8 ECU" >}}
...
{{< figure src="/img/sl8-datasheet/page07_img01.jpeg" caption="SL8 Connector A — looking into ECU connector." >}}
...
| A15 | Auxiliary Output 6  | A32 | Ignition Channel 7 / Digital Input 7 |
| A16 | Auxiliary Output 7  | A33 | Ignition Channel 8 / Digital Input 8 |
...
{{< figure src="/img/sl8-datasheet/page08_img01.jpeg" caption="SL8 Connector B — looking into ECU connector." >}}
...
{{< figure src="/img/sl8-datasheet/page11_img01.jpeg" caption="SL8 ECU pinout — Connector A and Connector B, looking into ECU. The Sensor 0V Ref pin is a specialised ground output for all analog sensors; connect direct to the sensor 0V pin." >}}

## Appendix B – SL Series ECU Wiring

{{< figure src="/img/sl8-datasheet/page12_img01.jpeg" caption="SL Series ECU typical wiring (drawing A21)." >}}

## Appendix C – SL Series Ethernet Wiring

{{< figure src="/img/sl8-datasheet/page13_img01.jpeg" caption="SL Series Ethernet pinout / tuning cable wiring (drawing A25)." >}}
