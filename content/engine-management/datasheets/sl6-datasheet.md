...
{{< figure src="/img/sl6-datasheet/page07_img01.jpeg" caption="SL6 Connector A — looking into ECU connector." >}}
...
{{< figure src="/img/sl6-datasheet/page11_img01.jpeg" caption="SL6 ECU pinout — Connector A and Connector B, looking into ECU. The Sensor 0V Ref pin is a specialised ground output for all analog sensors; connect direct to the sensor 0V pin." >}}

## Appendix B – SL Series ECU Wiring

{{< figure src="/img/sl6-datasheet/page12_img01.jpeg" caption="SL Series ECU typical wiring (drawing A21)." >}}

## Appendix C – SL Series Ethernet Wiring

{{< figure src="/img/sl6-datasheet/page13_img01.jpeg" caption="SL Series Ethernet pinout / tuning cable wiring (drawing A25)." >}}
