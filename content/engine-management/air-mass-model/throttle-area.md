---
title: "Throttle Body Area Tuning"
draft: true
weight: 93
---
...
Another way to validate Throttle Area and TMF Torque, would be to force the ECU into a "Torque Management" function (such as with **Throttle Plate(PID)** Torque Managed - [Launch Control](<launch-control.md>)) -> ![Image](</img/NewItem805.png>)
