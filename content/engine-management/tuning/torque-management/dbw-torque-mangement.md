...
1. Note the Throttle Cranking Area table. This ONLY gets applied during cranking and overrides any pedal request. See [Cranking Throttle Area Demand](<cranking-throttle-area-demand.md>)
...
See the [Pedal Demand Filter](<pedal-demand-filter.md>) help topic for more information.
...
See the [Pedal to Throttle Area Translation](<pedalto-throttle-translation.md>) help topic for more information.
