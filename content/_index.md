...
description: "Documentation, manuals, and technical resources for Emtron engine management, displays, transmission control, and accessories."
---
...
Welcome to the Emtron Resource Centre — your central hub for product manuals, configuration guides, wiring diagrams, datasheets, and technical articles.

Use the **search bar** in the sidebar to find topics quickly, or browse the sections below.
...
{{% /card %}}
{{% card href="https://emtron.world/" icon="fa-fw fas fa-globe" title="Emtron Website" %}}
Products, dealers, training events, and contact information.
{{% /card %}}
{{% /cards %}}
...
{{% cards %}}
{{% card href="/engine-management/" icon="fa-fw fas fa-microchip" title="Engine Management" %}}
ECU manuals for **KV Series**, **SL Series**, and **Shadow 8**. Covers configuration, tuning, wiring, diagnostics, and Emtune software.

- [Getting Started](/engine-management/getting-started/)
- [Datasheets](/engine-management/datasheets/)
- [Wiring & Pinouts](/engine-management/wiring/)
...
TCM setup and tuning for automated transmissions including **ZF 8HP** and **Nissan GR6**.

- [Getting Started](/transmission-control/getting-started/)
- [Tuning](/transmission-control/tuning/)
...
{{% /card %}}
{{% card href="/accessories/" icon="fa-fw fas fa-plug" title="Accessories" %}}
CAN gauges, input expanders, keypads, lambda-to-CAN modules, and other add-on hardware.
{{% /card %}}
{{% card href="/cdi/" icon="fa-fw fas fa-bolt" title="CDI Ignition" %}}
Capacitor Discharge Ignition systems by M&W Ignitions for high-energy spark applications.
{{% /card %}}
{{% card href="/motorsport/" icon="fa-fw fas fa-flag-checkered" title="Motorsport" %}}
Track map database and guides for creating custom geoJSON track maps.
{{% /card %}}
{{% card href="/articles/" icon="fa-fw fas fa-book" title="Technical Articles" %}}
In-depth technical articles on engine management topics.
{{% /card %}}
{{% /cards %}}
